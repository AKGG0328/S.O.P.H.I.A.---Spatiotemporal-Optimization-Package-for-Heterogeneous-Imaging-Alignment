...
# 5. Extract the Final SVM Features (The Cognitive Window)
print("\nExtracting feature matrix for Machine Learning...")
...
print(f"SVM Feature Matrix Shape: {feature_matrix.shape}")
